  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#09090B] flex flex-col items-center justify-center text-white font-sans">
        ...
        <p className="text-slate-400 font-inter text-sm animate-pulse">
  ...
  if (!hasAccess) {
    return (
      <div className="min-h-screen bg-[#09090B] flex items-center justify-center p-6 relative overflow-hidden font-sans">
        ...
        <div className="w-full max-w-md z-10 text-center animate-in fade-in zoom-in duration-300">
          <div className="inline-flex p-4 rounded-3xl bg-rose-500/10 border border-rose-500/20 mb-6 shadow-inner text-rose-400">
          ...
          <p className="text-slate-400 mt-3 font-inter text-sm max-w-sm mx-auto leading-relaxed">
          ...
          <div className="mt-8 flex flex-col gap-3">
            <Link
              href="/dashboard"
              className="py-3 px-6 rounded-2xl bg-white/5 border border-white/10 text-white font-bold text-sm hover:bg-white/10 active:scale-[0.98] transition-all flex items-center justify-center gap-2"
            >
            ...
            <button
              onClick={() => logout()}
              className="py-3 px-6 rounded-2xl bg-rose-500/20 border border-rose-500/30 text-rose-300 font-bold text-sm hover:bg-rose-500/30 active:scale-[0.98] transition-all flex items-center justify-center gap-2 cursor-pointer"
            >
