        ...
        <div className="glass border border-white/5 rounded-3xl p-8 shadow-2xl bg-slate-900/50 backdrop-blur-xl">
          {success ? (
            <div className="flex flex-col items-center justify-center py-6 text-center space-y-4">
              ...
              <p className="text-slate-400 font-inter text-sm max-w-xs">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <textarea
                    ...
                    rows={2}
                    className="w-full pl-11 pr-4 py-3.5 bg-slate-950/40 border border-slate-800 rounded-2xl text-white placeholder-slate-500 focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-all text-sm font-inter resize-none"
                    disabled={isSubmitting}
                  />
                </div>
              </div>
